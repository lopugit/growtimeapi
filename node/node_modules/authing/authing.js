...
module.exports.agora = module.exports.growtime = module.exports.planetexpress = module.exports.n = module.exports.a = (args) => {
	return new Promise((resolve, reject)=>{
		if(args.token){
			reject({
				success: false,
...
module.exports.provider = (args) => {
	/** will normalise a provider string */
		...
		if(provider == 'facebook' || provider == 'fb'){
			...
			return 'google'
		} else if(provider == 'growtime' || provider == 'a'){
			return 'growtime'
...
module.exports.providers = [ 'email', 'facebook', 'google', 'growtime' ] /** twitter, mobile, and github to come */