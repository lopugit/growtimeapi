...
express.post("/api/email/json", (req, res) => {
  ...
  if (req.body.json) {
    ...
    console.log("[growtimeapi][api][email][json][createTransport] Creating transport using service Gmail, username", secrets.email.email, "hashed password", hashedPassword)
